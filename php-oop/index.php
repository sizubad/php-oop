...
//memilih data dari tabel tb_user yang dimana id database dan id di url bernilai sama
$row = $db->query("SELECT * FROM tb_user WHERE id = $id")[0];
...
<head>
  ...
  <title>OOP by Sizubad - Home</title>
